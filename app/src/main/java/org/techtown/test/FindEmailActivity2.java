...
public class FindEmailActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        task = new phpdo();
        tv_email = (TextView)findViewById(R.id.tv_id);
        task.execute(userName,userNum);
        ...
        btn_to_login.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(FindEmailActivity2.this, MainActivity.class);
    ...
    private class phpdo extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try {
                ...
                String userNum = arg0[1];

                String link = "http://rarara14.ivyro.net/FindEmail.php?userName=" + userName + "&userNum=" + userNum; // 탐색하고싶은 url
